...
$sidebar_left_col  = n00b_get_sidebar_col_class($sidebar_pos, 'sidebar_left_col', 'col-md-2', '');
$sidebar_right_col = n00b_get_sidebar_col_class($sidebar_pos, 'sidebar_right_col', 'col-md-2', 'col-md-pull-8');
$article_col       = n00b_get_sidebar_col_class($sidebar_pos, 'article_col', 'col-md-8', 'col-md-push-2');
